...
# about 目录
    ...
    - company                
# about/company 页面工作空间

      - index.js             
# about/company 页面 js 入口文件

      - index.html           
# about/company 页面 html 入口文件

      - ...                  
# about/company 页面其他文件

    - platform               
# about/platform 页面工作空间

      - index.js             
# about/platform 页面 js 入口文件

      - index.html           
# about/platform 页面 html 入口文件
...
npm run analyze -- explore                  
# 模块分析 explore 页面 


# 构建多个页面 

npm run build -- home explore about
/* about/all --env test/prod 
```
...
const
 argv = minimist(process.argv.slice(
2
));
...
,
        ...
        test: 
/\.(gif|jpg|png|woff|woff2|svg|eot|ttf|ico)$/
,
...
const
 pages = argv._; 
// ['home', 'explore', 'about/*', 'about/all']

const
 allPages = getAllPages(pages); 
// 根据 page 中的 `*, all` 等关键字，获取所有真正的 pages
